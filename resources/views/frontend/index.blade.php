                    ...
                    <div class="col s12 m4">
                        <div class="card">
                            <div class="card-image">
                                    <span class="card-image-bg" style="background-image:url({{ $property->image }});"></span>
                                
                                    {{--  <img src="{{ $property->image }}" class="card-image-bg">  --}}
                    ...
                    <div class="card">
                        <div class="card-image">
                            @if(Storage::disk('public')->exists('posts/'.$post->image) && $post->image)
                                <span class="card-image-bg" style="background-image:url({{ $post->image }});"></span>
                            @endif
                        </div>
                        <div class="card-content">
