...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2021 at 06:12 PM
...
CREATE TABLE `properties` (
  ...
  `purpose` enum('rent') COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('house','apartment','seat') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `city_slug` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Admin', 'admin', '2021-01-28 12:22:12', NULL),
(2, 'Agent', 'agent', '2021-01-28 12:22:12', NULL),
(3, 'User', 'user', '2021-01-28 12:22:12', NULL);
...
INSERT INTO `settings` (`id`, `name`, `email`, `phone`, `address`, `footer`, `aboutus`, `facebook`, `twitter`, `linkedin`, `created_at`, `updated_at`) VALUES
(1, 'CoSpaceHub', 'cospacehub@gmail.com', '+8801303062727', 'Dhaka City College', '@CoSpaceHub Dhaka', 'Korem Ipsum BD DHaka Is My COmpany', 'https://facebook.com/Zeba', 'https://facebook.com/Zeba', 'https://facebook.com/Zeba', NULL, NULL);
...
(1, 'This is the slider title', 'Here is the log slider description', 'this-is-the-slider-title-2021-01-28-6013033d90bb4.jpg', '2021-01-28 12:32:29', '2021-01-28 12:32:29'),
(2, 'asdf', 'asdf', 'asdf-2021-01-28-60130357600be.jpg', '2021-01-28 12:32:55', '2021-01-28 12:32:55');
...
(1, 1, 'Admin', 'admin', 'admin@admin.com', 'admin-admin-1-2021-01-28.png', 'Bio of admin', '$2y$10$dOrIP4.4SC1EYITEqmyA8ul2svp8B.VtPnP25m0rF/IzRnMtRsr5K', 'lUC4c89Ch2eXncVTScmzUZNbg4E5LYiKaSyG99WaBQiMBcBhhQhyRydRCQ4f', '2021-01-28 12:22:12', '2021-01-28 12:26:41'),
(2, 2, 'Agent', 'agent', 'agent@agent.com', 'default.png', '', '$2y$10$PqLV2Qg0y9/1e.zZG2NF4eacn6wfLKEFVNtSo9rgSL5lZWraJQdkm', NULL, '2021-01-28 12:22:12', NULL),
(3, 3, 'User', 'user', 'user@user.com', 'default.png', NULL, '$2y$10$OnmJ8vzHm1II1CIk3kAvuuxtxgf9v4ARG1/mtgJ81IcykWhoIo5Jy', NULL, '2021-01-28 12:22:12', NULL);
